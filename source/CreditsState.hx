...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description (More like quotes lmao) - Link - BG Color
			['Sinner Squad'],
			...
			// ['Skye',                'skye',             'Miau -Skye (Co-Director, VA for Zero)',                                                                                                       'https://twitter.com/Skye6890',           'FF7575'],
			['Ninten',              'Ninten',           'Coffee -Ninten (Charter)',                                                                                                           'https://google.com',                     '8B8589'],
			['Zero',                'A4',               'Coding 4 life -Zero (Charter, Coder)',                                                                                               'guh123.carrd.co',                        '8C8C8C'],
